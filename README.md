...
> ❗️❗️ Model weights for reviewer evaluation can be accessed via [GoogleDrive](https://drive.google.com/drive/folders/1accDQApBzL3rTqTb0y_vmaz_hofWlnyp?usp=sharing). To request a demo trial account or ask about access, please contact [Yingxue Xu](mailto:yxueb@connect.ust.hk).
